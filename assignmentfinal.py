...
# Define a function line_chart to represent data as a line chart
def line_chart():
...
# Define a function pie_chart to represent data as a pie chart
def pie_chart():
...
# Define a function bar_chart to represent data as a bar chart
def bar_chart():
    ...
    ax.bar(x - width/2, year2020, width, label='2020')
    ax.bar(x + width/2, year2021, width, label='2021')
